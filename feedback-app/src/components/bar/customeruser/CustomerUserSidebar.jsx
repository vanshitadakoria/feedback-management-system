...
const CustomerUserSidebar = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
        try {
            const data = await getCustomerUserById(CustomerUserId);
      ...
      <ProSidebar collapsed={isCollapsed} >
        <Menu iconShape="square" >
          ...
          <Box paddingLeft={isCollapsed ? undefined : "10%"}>
            ...
            <Item
              title="Show"
              to="customeruser/questionnaires"
...
export default CustomerUserSidebar;